...
class Upload extends React.Component {
    ...
    processUpload = () => {
        ...
        //     url, base64Image
        // };
        this.props.add_photo(userId,caption,posted,base64Image,username);
...
const mapDispatchToProps = (dispatch) => {
    return {
        add_photo: (userId,caption,posted,base64Image,username) => { dispatch(add_photo(userId,caption,posted,base64Image,username))},
    }
}
